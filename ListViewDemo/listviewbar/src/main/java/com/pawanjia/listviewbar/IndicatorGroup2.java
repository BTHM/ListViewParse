...
public class IndicatorGroup2 extends FrameLayout {
    ...
    public IndicatorGroup2(Context context) {
        this(context, null);
    }

    public IndicatorGroup2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IndicatorGroup2(Context context, AttributeSet attrs, int defStyleAttr) {
