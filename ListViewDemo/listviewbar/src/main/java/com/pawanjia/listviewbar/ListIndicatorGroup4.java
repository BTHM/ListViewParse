...
public class ListIndicatorGroup4 extends FrameLayout {
    ...
    public ListIndicatorGroup4(Context context) {
        this(context, null);
    }

    public ListIndicatorGroup4(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ListIndicatorGroup4(Context context, AttributeSet attrs, int defStyleAttr) {
