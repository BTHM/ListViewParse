...
public class ListIndicatorViewGroup extends FrameLayout {
    ...
    public ListIndicatorViewGroup(Context context) {
        this(context, null);
    }

    public ListIndicatorViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ListIndicatorViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        indicator.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                textAreaWidth = indicator.getMeasuredWidthText();
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        WJLog.d("ListIndicator3","ListIndicatorGroup...dispatchTouchEvent..."+ev.getAction());
        WJLog.d("ListIndicator3","ListIndicatorGroup...dispatchTouchEvent..."+super.dispatchTouchEvent(ev));
        return super.dispatchTouchEvent(ev);
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        WJLog.d("ListIndicator3","ListIndicatorGroup...onInterceptTouchEvent..."+ev.getAction());
    ...
    public boolean onTouchEvent(MotionEvent event) {
        WJLog.d("ListIndicator3","ListIndicatorGroup...onTouchEvent..."+event.getAction());
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE:
                float moveX = event.getX();
                float moveY = event.getY();
                //Log.d("tag", "ACTION_MOVE+moveX=" + moveX + "moveY=" + moveY);
                //if (Math.abs(moveY - downY) < Math.abs(moveX - downX)) {
            ...
            case MotionEvent.ACTION_UP:
                //Log.d("tag", "ACTION_UP+totalDx=" + totalDx);
