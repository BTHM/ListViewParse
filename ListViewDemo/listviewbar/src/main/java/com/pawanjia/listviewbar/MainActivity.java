...
public class MainActivity extends AppCompatActivity {
    ...
    private IndicatorList5 mIndicator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIndicator = (IndicatorList5) findViewById(R.id.list);
        ...
        mIndicator.setOnTouchListner(new IndicatorList5.OnTouchListner() {
            @Override
        ...
        mIndicator.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                int textAreaWidth = mIndicator.getTextAreaWidth();
